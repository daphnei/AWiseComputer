...
::com::text::attack::world::WorldGrid_obj::__register();
...
::com::text::attack::levels::Level5_obj::__register();
::com::text::attack::levels::Level4_obj::__register();
::com::text::attack::levels::Level3_obj::__register();
::com::text::attack::levels::Level2_obj::__register();
::com::text::attack::levels::Level1_obj::__register();
::com::text::attack::levels::Level_obj::__register();
::Type_obj::__register();
...
::com::text::attack::Main_obj::__register();
...
::com::text::attack::Main_obj::__boot();
...
::Type_obj::__boot();
::com::text::attack::levels::Level_obj::__boot();
::com::text::attack::levels::Level1_obj::__boot();
::com::text::attack::levels::Level2_obj::__boot();
::com::text::attack::levels::Level3_obj::__boot();
::com::text::attack::levels::Level4_obj::__boot();
::com::text::attack::levels::Level5_obj::__boot();
...
::com::text::attack::world::WorldGrid_obj::__boot();
