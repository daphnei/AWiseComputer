...
Void Comet_obj::__construct(int x,int y)
{
HX_STACK_FRAME("com.text.attack.world.Comet","new",0x83eaaff4,"com.text.attack.world.Comet.new","com/text/attack/world/Comet.hx",14,0xb61a9a5e)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
HX_STACK_ARG(y,"y")
{
	HX_STACK_LINE(15)
	super::__construct(::com::text::attack::world::CellType_obj::Comet,x,y);
	HX_STACK_LINE(17)
	::com::text::attack::utiltiies::Assert_obj::_assert((::com::text::attack::world::World_obj::instance != null()),hx::SourceInfo(HX_CSTRING("Comet.hx"),17,HX_CSTRING("com.text.attack.world.Comet"),HX_CSTRING("new")));
	HX_STACK_LINE(18)
	::com::text::attack::utiltiies::Assert_obj::_assert((::com::text::attack::world::World_obj::instance->grid != null()),hx::SourceInfo(HX_CSTRING("Comet.hx"),18,HX_CSTRING("com.text.attack.world.Comet"),HX_CSTRING("new")));
}
;
	return null();
}
...
hx::ObjectPtr< Comet_obj > Comet_obj::__new(int x,int y)
...
{
		HX_STACK_FRAME("com.text.attack.world.Comet","destroy",0xbdc6668e,"com.text.attack.world.Comet.destroy","com/text/attack/world/Comet.hx",33,0xb61a9a5e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(34)
