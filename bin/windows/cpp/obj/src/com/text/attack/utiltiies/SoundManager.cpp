...
{
HX_STACK_FRAME("com.text.attack.utiltiies.SoundManager","new",0x5972e390,"com.text.attack.utiltiies.SoundManager.new","com/text/attack/utiltiies/SoundManager.hx",22,0xe97d293e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
{
		HX_STACK_FRAME("com.text.attack.utiltiies.SoundManager","playRandomNote",0x318b2979,"com.text.attack.utiltiies.SoundManager.playRandomNote","com/text/attack/utiltiies/SoundManager.hx",41,0xe97d293e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
...
{
		HX_STACK_FRAME("com.text.attack.utiltiies.SoundManager","playRandomChord",0xce2c80f5,"com.text.attack.utiltiies.SoundManager.playRandomChord","com/text/attack/utiltiies/SoundManager.hx",49,0xe97d293e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(50)
		this->stopOtherSounds();
		HX_STACK_LINE(52)
...
{
		HX_STACK_FRAME("com.text.attack.utiltiies.SoundManager","playEndSound",0xaa4023d8,"com.text.attack.utiltiies.SoundManager.playEndSound","com/text/attack/utiltiies/SoundManager.hx",57,0xe97d293e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(58)
		::openfl::_v2::media::SoundChannel _g = this->endSound->play(null(),null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(58)
		this->endSoundChannel = _g;
	}
return null();
}
...
Void SoundManager_obj::stopOtherSounds( ){
{
		HX_STACK_FRAME("com.text.attack.utiltiies.SoundManager","stopOtherSounds",0xa37d1e02,"com.text.attack.utiltiies.SoundManager.stopOtherSounds","com/text/attack/utiltiies/SoundManager.hx",63,0xe97d293e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(63)
...
HX_DEFINE_DYNAMIC_FUNC0(SoundManager_obj,stopOtherSounds,(void))
...
void SoundManager_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(endSoundChannel,"endSoundChannel");
	HX_MARK_END_CLASS();
}
...
void SoundManager_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(endSoundChannel,"endSoundChannel");
}
...
Dynamic SoundManager_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"endSoundChannel") ) { return endSoundChannel; }
		if (HX_FIELD_EQ(inName,"playRandomChord") ) { return playRandomChord_dyn(); }
		if (HX_FIELD_EQ(inName,"stopOtherSounds") ) { return stopOtherSounds_dyn(); }
	}
...
Dynamic SoundManager_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"endSoundChannel") ) { endSoundChannel=inValue.Cast< ::openfl::_v2::media::SoundChannel >(); return inValue; }
	}
...
void SoundManager_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("endSoundChannel"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::media::SoundChannel*/ ,(int)offsetof(SoundManager_obj,endSoundChannel),HX_CSTRING("endSoundChannel")},
	{ hx::fsUnknown, 0, null()}
};
#endif
