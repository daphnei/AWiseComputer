		...
		while((true)){
			...
			HX_STACK_LINE(78)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(82)
					if (((cell->cellType == ::com::text::attack::world::CellType_obj::Comet))){
						HX_STACK_LINE(83)
						color = (int)16732004;
					}
					else{
...
{
		HX_STACK_FRAME("com.text.attack.world.WorldGrid","printCell",0x229ba14b,"com.text.attack.world.WorldGrid.printCell","com/text/attack/world/WorldGrid.hx",100,0x6459e016)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		struct _Function_1_1{
			inline static ::com::text::attack::world::Cell Block( hx::ObjectPtr< ::com::text::attack::world::WorldGrid_obj > __this,int &x,int &y){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/text/attack/world/WorldGrid.hx",101,0x6459e016)
				{
					HX_STACK_LINE(101)
		...
		HX_STACK_LINE(101)
		::haxe::Log_obj::trace(_g,hx::SourceInfo(HX_CSTRING("WorldGrid.hx"),101,HX_CSTRING("com.text.attack.world.WorldGrid"),HX_CSTRING("printCell")));
	}
return null();
}
