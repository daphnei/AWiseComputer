...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Daphne", "TextAttack", "com.text.attack.TextAttack", "1.0.0");
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.text.attack.Main, []);
			}
