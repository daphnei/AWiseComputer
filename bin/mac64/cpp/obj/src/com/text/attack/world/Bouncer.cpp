...
{
HX_STACK_FRAME("com.text.attack.world.Bouncer","new",0xd54d846e,"com.text.attack.world.Bouncer.new","com/text/attack/world/Bouncer.hx",15,0xcaa3cfa4)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
HX_STACK_ARG(y,"y")
{
...
int Bouncer_obj::getSymbol( ){
	HX_STACK_FRAME("com.text.attack.world.Bouncer","getSymbol",0x1e996b1c,"com.text.attack.world.Bouncer.getSymbol","com/text/attack/world/Bouncer.hx",20,0xcaa3cfa4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(20)
