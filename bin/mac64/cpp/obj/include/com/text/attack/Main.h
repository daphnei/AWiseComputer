...
#define INCLUDED_com_text_attack_Main
...
HX_DECLARE_CLASS3(com,text,attack,Main)
...
class HXCPP_CLASS_ATTRIBUTES  Main_obj : public ::openfl::_v2::display::Sprite_obj{
	...
	public:
		...
		bool inited;
		::com::text::attack::world::World world;
		virtual Void resize( Dynamic e);
		Dynamic resize_dyn();

		virtual Void update( ::openfl::_v2::events::Event event);
		Dynamic update_dyn();
...
#endif /* INCLUDED_com_text_attack_Main */ 
